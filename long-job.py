...
def main():
    ...
    # Load data
    df = pd.read_csv('/home/posit/01-positron101/weather.csv')
    ...
    print("Saving plot...")
    time.sleep(5)
    plt.savefig('/home/posit/01-positron101/weather_plot_py.png')
    ...
    time.sleep(3)
    summary.to_csv('/home/posit/01-positron101/weather_summary_py.csv')
